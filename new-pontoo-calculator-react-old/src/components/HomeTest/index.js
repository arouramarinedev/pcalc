        ...
        <>
            <div className="calculator">
                <div className="calculator--container" style={{ background: '#f8fcff' }}> {/*  E9F6FF*/}
                    <div className="container" style={{ color: '#102174' }}> {/* calculator-box */}
                        <div className="row">
                            <div className="col">
                        ...
                        <div className="row">
                            {/*COLUMN LEFT*/}
                            <div className="col"> {/*bp calculator-left */}
                                <div className="checkmark-box" style={{ background: 'white !important' }}>
                                    <ul className="calculator-list" style={{ listStyle: 'none' }}>
                                        <li><i className="bi bi-star-fill text-danger me-1"></i>Calculate the Sq. Ft. of your pontoons</li>
                                        <li><i className="bi bi-star-fill text-danger me-1"></i>Calculate the amount of product you need</li>
                                        <li><i className="bi bi-star-fill text-danger me-1"></i>Get a Quote</li>
                                        <li><i className="bi bi-star-fill text-danger me-1"></i>Get your 3 year Factory Warranty</li>
                                    </ul>
                                </div>
                                <br />
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" min={0} required className="feet" name="pontoonLength1" placeholder="Length in Feet" tabIndex={1} autofocus /></td>
                                                    <td><input type="text" min={0} className="feet" name="pontoonLength2" placeholder="Length in Feet" tabIndex={4} /></td>
                                                    <td><input type="text" min={0} className="feet" name="pontoonLength3" placeholder="Length in Feet" tabIndex={7} /></td>
                                                </tr>
                                                <tr>
                                                    <td><span className="numbered-item">2.</span></td>
                                                    <td><input type="text" min={0} required className="inch" name="pontoonRadius1" placeholder="Radius in Inches" tabIndex={2} /></td>
                                                    <td><input type="text" min={0} className="inch" name="pontoonRadius2" placeholder="Radius in Inches" tabIndex={5} /></td>
                                                    <td><input type="text" min={0} className="inch" name="pontoonRadius3" placeholder="Radius in Inches" tabIndex={8} /></td>
                                                </tr>
                                                <tr>
                                                    <th />
                                                    <td />
                            ...
                            {/*COLUMN RIGHT*/}
                            <div className="col fw-bold fst-italic" style={{ marginTop: '0.1px', }}> {/* */}
                                <div style={{
                                    color: '#102174',
                                    borderRadius: '15px',
                                    border: '1px solid #d5d5d5',
                                    ...
                                    <div className="max-320">
                                        <span className="font-31">Everything you need</span> <br /><span style={{fontSize: '17px',}}>to clean and brighten your pontoons, remove marine fouling, stains, streaks, acid etching, protect them with 3 Year Clear Coat and antifoul them.<br />
                                        <br />
                                        <span style={{ color: 'red' }}>Make your pontoons look new again and add thousands of dollars in value to your boat.</span></span>
                                    </div>
                                ...
                                <div style={{
                                    ...
                                    <ul style={{ fontSize: '16px', listStyle: 'none' }}>
                                        <li className="mb-1 mt-3"><span style={{ color: 'green' }}>✓ </span>Pontoons Stay Clean and Shiny Year After Year</li>
                                        <li className="mb-1"><span style={{ color: 'green' }}>✓ </span>Pride of Ownership. Your Boat is a Reflection of Your Personality.</li>
                                        <li className="mb-1"><span style={{ color: 'green' }}>✓ </span>Greater Trade or Resale Value. Adding $5,000 to $10,000 is Common.</li>
                                        <li className="mb-1"><span style={{ color: 'green' }}>✓ </span>Better Fuel Economy. Reduce Fuel Consumption Up to 20%.</li>
                                        <li className="mb-1"><span style={{ color: 'green' }}>✓ </span>Easier Maintenance. Pontoons Can Stay Fouling Free All Summer.</li>
                                        <li className="mb-1"><span style={{ color: 'green' }}>✓ </span>Lasts up to 10 Years. Save Money by Reducing Costly Annual Maintenance.</li>
                                    </ul>
                                </div><br /><br />
                            </div>
                        </div>
